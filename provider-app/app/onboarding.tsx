...
export default function OnboardingScreen() {
    ...
    const saveStep1to3 = async () => {
        ...
        try {
            ...
            // 2. Update provider details (STRICT: onboarding_completed = true, is_online = false)
            const { error: providerError } = await supabase
                ...
                .update({
                    ...
                    is_online: false, // Requirement: offline first
                    updated_at: new Date()
                })
            ...
            // Pre-cache that onboarding is complete for smoother transitions
            router.replace('/(tabs)');
        } catch (error: any) {
    ...
    const nextStep = () => {
        ...
        else if (step === 3 && city && pincode) saveStep1to3();
        else if (step === 4) {
