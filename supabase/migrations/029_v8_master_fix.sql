-- ==============================================================
-- WORKLA BATCH 8.1: AUTH & DASHBOARD ROBUSTNESS MASTER FIX
-- Purpose: Fix "Database Error" during signup and dashboard load
-- ==============================================================

-- 1. Enable required extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 2. Restore missing columns in profiles (needed for dashboard)
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS preferred_location_lat DOUBLE PRECISION;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS preferred_location_lng DOUBLE PRECISION;

-- 3. Robust handle_new_auth_user trigger
...
-- 5. Fix RLS for Admin Visibility (Ensures portal works)
